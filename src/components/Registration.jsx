...
function Registration() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Google Form URL should be hardcoded - if missing, it's a configuration error
    if (!googleFormUrl) {
      console.error('❌ Google Form URL is not configured in code!')
      alert('❌ System error: Google Form URL is not configured. Please contact the administrator.')
      setSubmitting(false)
